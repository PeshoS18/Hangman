...
const wordLists = {
    ...
    BG: {
        easy: ['коте', 'куче', 'птица', 'риба', 'дърво', 'книга', 'химикал', 'къща', 'кола', 'слънце', 'луна', 'звезда', 'ябълка', 'топка', 'игра'],
        medium: ['платка', 'компютър', 'разработка', 'прозорец', 'клавиатура', 'монитор', 'интернет', 'сървър', 'мрежа', 'база', 'функция', 'променлива', 'алгоритъм', 'програма', 'система'],
